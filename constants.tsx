...
// Using SVG paths directly to avoid external icon library dependencies
export const Icons = {
  ...
  MicOff: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><line x1="1" x2="23" y1="1" y2="23"/><path d="M9 9v3a3 3 0 0 0 5.12 2.12"/><line x1="15.009" x2="15.009" y1="2.119" y2="2.12"/><path d="M16.86 6.86a3 3 0 0 0-2.81-1.86A3 3 0 0 0 12 8v7.28"/><path d="M19 10v2a7 7 0 0 1-13.3 2.7"/></svg>
  ),
  ...
  Cloud: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M17.5 19c0-3.037-2.463-5.5-5.5-5.5S6.5 15.963 6.5 19"/><path d="M20.3 15.2c.26-.82.4-1.7.4-2.6 0-4.42-3.58-8-8-8a8.006 8.006 0 0 0-7.3 4.8C2.5 10 0 12.5 0 15.5c0 2.2 1.8 4 4 4h1.5"/></svg>
  ),
...
export const MOOD_COLORS = {
  ecstatic: 'bg-gradient-to-br from-yellow-100 to-yellow-300 border-yellow-400',
  happy: 'bg-gradient-to-br from-green-100 to-green-300 border-green-400',
  neutral: 'bg-gradient-to-br from-gray-100 to-gray-300 border-gray-400',
  sad: 'bg-gradient-to-br from-blue-100 to-blue-300 border-blue-400',
  anxious: 'bg-gradient-to-br from-purple-100 to-purple-300 border-purple-400',
  angry: 'bg-gradient-to-br from-red-100 to-red-300 border-red-400',
  tired: 'bg-gradient-to-br from-stone-200 to-stone-400 border-stone-500'
};
